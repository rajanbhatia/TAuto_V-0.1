...
public class KeyPress
{
	...
	public void keyXpath(String xpath, String key, WebDriver driver)
	{
		switch (key)
		{
	...
	public void keyId(String id, String key, WebDriver driver)
	{
		switch (key)
		{
	...
	public void keyName(String name, String key, WebDriver driver)
	{	
		switch (key)
		{
	...
	public void keyCssSelector(String css, String key, WebDriver driver)
	{	
		switch (key)
		{
